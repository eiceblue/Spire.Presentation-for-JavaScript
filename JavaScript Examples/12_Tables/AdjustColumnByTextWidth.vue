<template>
  <span>The following example demonstrates how to adjust column by text width in PowerPoint document</span>
  ...
  setup() {
    ...
    const startProcessing = async () => {
      ...
      if (wasmModule) {
        ...
        const outputFileName = "AdjustColumnByTextWidth.pptx";
