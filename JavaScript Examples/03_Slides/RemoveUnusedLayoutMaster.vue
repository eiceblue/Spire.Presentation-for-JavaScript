<template>
  <span>Click the following button to remove unused master layouts from PowerPoint.</span>
  ...
  setup() {
    ...
    const startProcessing = async () => {
      ...
      if (wasmModule) {
        ...
        let inputFileName = "PPTSample_1.pptx";
        ...
        const outputFileName = "RemoveUnusedLayoutMaster.pptx";
