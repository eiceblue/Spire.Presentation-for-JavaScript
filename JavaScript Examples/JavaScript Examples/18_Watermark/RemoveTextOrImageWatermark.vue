<template>
  <span>Click the following button to remove text or image watermarks. </span>
  ...
  setup() {
    ...
    const startProcessing = async () => {
      ...
      if (wasmModule) {
        ...
        let inputFileName = 'RemoveTextAndImageWatermarks.pptx';
        ...
        const outputFileName = 'RemoveTextAndImageWatermarks.pptx';
