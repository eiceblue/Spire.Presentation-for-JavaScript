<template>
  <span>Click the following button to remove SmartArt node at specific position. </span>
  ...
  setup() {
    ...
    const startProcessing = async () => {
      ...
      if (wasmModule) {
        ...
        let inputFileName = 'RemoveNode.pptx';
        ...
        const outputFileName = 'RemoveNode.pptx';
