<template>
  <span>Click the following button to set borders and shading of shapes in a PPT document.</span>
  ...
  setup() {
    ...
    const startProcessing = async () => {
      ...
      if (wasmModule) {
        ...
        let inputFileName = "BordersAndShading.pptx";
        ...
        const outputFileName = "BordersAndShading.pptx";
