<template>
  <span>Click the following button to remove text box from PPT document.</span>
  ...
  setup() {
    ...
    const startProcessing = async () => {
      ...
      if (wasmModule) {
        ...
        let inputFileName = "TextBoxTemplate.pptx";
        ...
        const outputFileName = "RemoveTextBox.pptx";
