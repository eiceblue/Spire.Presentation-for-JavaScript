<template>
  <span>Click the following button to set columns count of textFrame on PPT document.</span>
  ...
  setup() {
    ...
    const startProcessing = async () => {
      ...
      if (wasmModule) {
        ...
        let inputFileName = "ColumnsCount.pptx";
        ...
        const outputFileName = "SetColumnsCountOfTextFrame.pptx";
