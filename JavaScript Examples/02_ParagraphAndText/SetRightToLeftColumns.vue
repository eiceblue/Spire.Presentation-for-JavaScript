<template>
  <span>Click the following button to set the columns style to Right-To-Left in a PPT document.</span>
  ...
  setup() {
    ...
    const startProcessing = async () => {
      ...
      if (wasmModule) {
        ...
        let inputFileName = "TwoColumns.pptx";
        ...
        const outputFileName = "SetRightToLeftColumns.pptx";
