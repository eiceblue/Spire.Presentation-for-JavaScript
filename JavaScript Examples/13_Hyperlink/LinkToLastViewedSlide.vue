<template>
  <span>Click the following button to link to the last viewed slide.</span>
  ...
  setup() {
    ...
    const startProcessing = async () => {
      ...
      if (wasmModule) {
        ...
        let inputFileName = "LastViewedSlide.pptx";
        ...
        const outputFileName = "LinkToLastViewedSlide_out.pptx";
