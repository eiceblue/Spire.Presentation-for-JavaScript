<template>
  <span>Click the following button to remove chart from a slide in PowerPoint document.</span>
  ...
  setup() {
    ...
    const startProcessing = async () => {
      ...
      if (wasmModule) {
        ...
        let inputFileName = "Template_Ppt_3.pptx";
        ...
        const outputFileName = "RemoveChartFromPptSlide_out.pptx";
