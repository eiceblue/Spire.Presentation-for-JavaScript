<template>
  <span>Click the following button to group two-level axis labels in a chart.</span>
  ...
  setup() {
    ...
    const startProcessing = async () => {
      ...
      if (wasmModule) {
        ...
        let inputFileName = "GroupTwoLevelAxisLabels.pptx";
        ...
        const outputFileName = "GroupTwoLevelAxisLabels_out.pptx";
