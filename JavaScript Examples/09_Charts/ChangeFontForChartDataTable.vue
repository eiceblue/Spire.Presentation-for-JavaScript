<template>
  <span>Click the following button to change font size for chart data table in a PPT document.  </span>
  ...
  setup() {
    ...
    const startProcessing = async () => {
      ...
      if (wasmModule) {
        ...
        const outputFileName = "ChangeFontForChartDataTable_out.pptx";
