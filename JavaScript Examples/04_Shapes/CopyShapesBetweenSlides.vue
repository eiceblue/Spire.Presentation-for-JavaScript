<template>
  <span>The sample demonstrates how to copy shapes between slides in a PPT document.</span>
  ...
  setup() {
    ...
    const startProcessing = async () => {
      ...
      if (wasmModule) {
        ...
        const inputFileName = "CopyShapesBetweenSlides.pptx";
        ...
        const outputFileName = "CopyShapesBetweenSlides_out.pptx";
