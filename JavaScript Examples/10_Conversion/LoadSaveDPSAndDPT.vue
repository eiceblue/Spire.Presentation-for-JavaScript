<template>
  <span>The following example demonstrates how to load and save the DPS and DPT format document</span>
  ...
  setup() {
    ...
    const startProcessing = async () => {
      ...
      if (wasmModule) {
        ...
        const modifiedFile = new Blob([modifiedFileArray], { type: "application/dps" });
