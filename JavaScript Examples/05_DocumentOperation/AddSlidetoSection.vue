<template>
  <span>The example shows how to add one slide into a specified section. </span>
  ...
  setup() {
    ...
    const startProcessing = async () => {
      ...
      if (wasmModule) {
        ...
        const inputFileName = "Section.pptx";
        ...
        const outputFileName = "AddSlideToSection_out.pptx";
