<template>
  <span>Click the following button to extract comments from presentation slides.</span>
  ...
  setup() {
    ...
    const startProcessing = async () => {
      ...
      if (wasmModule) {
        ...
        const outputFileName = "ExtractComments_out.txt";
        ...
        const modifiedFile = new Blob([modifiedFileArray], { type: "text/palin" });
